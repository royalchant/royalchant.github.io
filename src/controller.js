...
var toggleLyric = function() {
  ...
  if (show_lyric) {
    show_lyric = false;
    if (first_run) {
    	document.getElementById("Video").innerHTML = '<iframe width="853" height="480" src="https://www.youtube.com/embed/XS3raZ8aOj4" frameborder="0" allowfullscreen></iframe>'
     	first_run = false;
    } else {
