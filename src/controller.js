...
var style1 = '{margin: 0;padding: 0;}html {background: url("img/RC_3.jpg") no-repeat center center fixed;-webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;}'
